   ...
   e:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if (date(&r)) {
  14:	50                   	push   %eax
  15:	e8 31 03 00 00       	call   34b <date>
  ...
  21:	50                   	push   %eax
  22:	50                   	push   %eax
  23:	68 08 07 00 00       	push   $0x708
  28:	6a 02                	push   $0x2
  2a:	e8 d1 03 00 00       	call   400 <printf>
    exit();
  2f:	e8 6f 02 00 00       	call   2a3 <exit>
  }

  // your code to print the time in any format you like...
  printf(1, "%d-%d-%d %d:%d:%d UTC\n",
  34:	ff 75 e0             	push   -0x20(%ebp)
  37:	ff 75 e4             	push   -0x1c(%ebp)
  3a:	ff 75 e8             	push   -0x18(%ebp)
  3d:	ff 75 ec             	push   -0x14(%ebp)
  40:	ff 75 f0             	push   -0x10(%ebp)
  43:	ff 75 f4             	push   -0xc(%ebp)
  46:	68 15 07 00 00       	push   $0x715
  4b:	6a 01                	push   $0x1
  ...
  55:	e8 49 02 00 00       	call   2a3 <exit>
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
  5e:	66 90                	xchg   %ax,%ax
 ...
 368:	89 d1                	mov    %edx,%ecx
{
 ...
 39b:	0f b6 92 8c 07 00 00 	movzbl 0x78c(%edx),%edx
 ...
 409:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 474:	ff 24 85 34 07 00 00 	jmp    *0x734(,%eax,4)
 ...
 580:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 585:	bb 2c 07 00 00       	mov    $0x72c,%ebx
